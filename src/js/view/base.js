export const elements = {
    ...
    fruitsAddOn: Array.from(document.getElementById('fruitAddOn').getElementsByTagName('input')),
    toppingAddOn: Array.from(document.getElementById('toppingAddOn').getElementsByTagName('input')),
